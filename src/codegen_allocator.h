...
/*Toggle JIT memory between writable (for code generation) and executable (for running generated code).
  Required on Apple Silicon macOS where MAP_JIT enforces write-or-execute permissions.*/
